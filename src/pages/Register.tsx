...
const Register = () => {
  ...
  return (
    ...
    className="min-h-screen bg-background flex items-center justify-center p-4"  data-page="register">
      <div className="w-full max-w-md">
        ...
        <Card className="border-card-border bg-card/10 backdrop-blur-sm opacity-200" style={{
    backgroundColor: "rgb(92, 25, 100)",
